...
pipeline_components.append('XGBClassifier', XGBClassifier ())
...
pipeline_parameters['XGBClassifier'] = \
   [{'n_estimators': n_estimators_values, 'learning_rate': learning_rate_values, 'gamma': gamma_values, 'max_depth': max_depth_values, 'subsample': subsample_values, 'seed': 324089, 'nthread': 1}
     ]
