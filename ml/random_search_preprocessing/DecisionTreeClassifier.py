...
pipeline_components.append('DecisionTreeClassifier', DecisionTreeClassifier())
...
pipeline_parameters[DecisionTreeClassifier] = \
   {'min_impurity_decrease': min_impurity_decrease_values, 'max_features': max_features_values, 'criterion': criterion_values, 'max_depth': max_depth_values, 'random_state': 324089}
